                                    ...
                                    <dl>
                                        <dd>
                                            <div class="btn-buy" id="buyButton">
                                                <button class="buy" onclick="cartAdd2">立即购买</button>
...
<script>
    ...
    import {setItem,getItem} from '../../../kit/localStorageKit.js'
    ...
    export default {
        ...
        methods: {
            ...
            cartAdd(){
                ...
                var bCount = this.buyCount;
                // console.log(this.$route.params.goodsid);
                // 以下通过vuex方式来触发main.js中的dispath事件 购物车中的数量 的改变 key:'changeBuyCount'
                // this.$store.dispatch('changeButCountmapActions',bCount);
                ...
                // 设置localStorage Item
                // setItem('buyGoodsCount',JSON.stringify({gid:this.$route.params.goodsid},{bCount:this.buyCount}));
                // 注意下面的bcount是全小写的，吸取教训，不能再写大写
